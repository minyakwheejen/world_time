...
action="index.php?include=konfirmasi-edit-penulis">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <textarea class="form-control" name="alamat" id="editor1" rows="12" value ="<?php echo $alamat;?>"><?php echo $alamat;?></textarea>
            </div>
          </div>
        </div>
        <!-- /.card-body -->
