...
?>
    ...
    <section class="content">
            <div class="card">
              ...
              <div class="card-body">
              <div class="col-md-12">
                  <form method="post" action="index.php?include=kategori-berita">
                    <div class="row">
                ...
                <table class="table table-bordered">
                  ...
                  <?php 
                    ...
                    if(isset($kata_kunci) && !empty($kata_kunci)){
                      $sql_k .= "WHERE `kategori_berita` LIKE '%$kata_kunci%' ";
                    }
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="index.php?include=kategori-berita&aksi=hapus&data= <?php echo $id_kategori_berita;?>&notif=hapusberhasil" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; }?>
              ...
              if($halaman!=1){
                ...
                <a class='page-link' href='index.php?include=kategori-berita&halaman=1'>
                First</a></li>";
                echo "<li class='page-item'>
                <a class='page-link' href='index.php?include=kategori-berita&halaman=$sebelum'>
                «</a></li>";
              }
              for($i=1; $i<=$jum_halaman; $i++){
                  if($i!=$halaman){
                    echo "<li class='page-item'>
                    <a class='page-link' href='index.php?include=kategori-berita&halaman=$i'>
                    $i</a></li>";
                  }else{
                      echo "<li class='page-item'>
              ...
              if($halaman!=$jum_halaman){
                  echo "<li class='page-item'>
                  <a class='page-link' href='index.php?include=kategori-berita&halaman=$setelah'>
                  »</a></li>";
                  echo "<li class='page-item'>
                  <a class='page-link' href='index.php?include=kategori-berita&halaman=$jum_halaman'>
                  Last</a></li>";
              }
              }?>
              </ul>
