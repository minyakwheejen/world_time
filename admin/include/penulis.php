...
?>
    ...
    <section class="content">
            <div class="card">
              ...
              <div class="card-body">
              <div class="col-md-12">
                  <form method="post" action="index.php?include=penulis">
                    <div class="row">
                ...
                <table class="table table-bordered">
                  ...
                  <?php 
                      ...
                      if(isset($kata_kunci) && !empty($kata_kunci)){
                        $sql_k .= "WHERE `penulis` LIKE '%$kata_kunci%' ";
                      }
                    ...
                    <tr>
                          ...
                          <a href="index.php?include=penulis&aksi=hapus&data= <?php echo $id_penulis;?>&notif=hapusberhasil" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
                          </td>
                      </tr>
                      <?php $no++;}?>
                      </tbody>
              ...
              $sql_jum = "select `id_penulis`, `penulis` ,`alamat` from    
                      `penulis`"; 
              ...
              if($halaman!=1){
                ...
                <a class='page-link' href='index.php?include=penulis&halaman=1'>
                First</a></li>";
                echo "<li class='page-item'>
                <a class='page-link' href='index.php?include=penulis&halaman=$sebelum'>
                «</a></li>";
              }
              for($i=1; $i<=$jum_halaman; $i++){
                  if($i!=$halaman){
                    echo "<li class='page-item'>
                    <a class='page-link' href='index.php?include=penulis&halaman=$i'>
                    $i</a></li>";
                  }else{
                      echo "<li class='page-item'>
              ...
              if($halaman!=$jum_halaman){
                  echo "<li class='page-item'>
                  <a class='page-link' href='index.php?include=penulis&halaman=$setelah'>
                  »</a></li>";
                  echo "<li class='page-item'>
                  <a class='page-link' href='index.php?include=penulis&halaman=$jum_halaman'>
                  Last</a></li>";
              }
              }?>
              </ul>
